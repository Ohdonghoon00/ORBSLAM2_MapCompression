...
// {
//     Eigen::Vector3d rod;
//     rod << pose[3], pose[4], pose[5];
//     Eigen::Matrix3d rot = ToMat33(rod);
//     float motion[] = {(float)rot(0, 0), (float)rot(0, 1), (float)rot(0, 2), (float)rod.x(),
//                       (float)rot(1, 0), (float)rot(1, 1), (float)rot(1, 2), (float)rod.y(),
//                       (float)rot(2, 0), (float)rot(2, 1), (float)rot(2, 2), (float)rod.z(),
